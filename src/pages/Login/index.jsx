...
export default function Login() {
    ...
    // gestionnaire pour mettre à jour les données du formulaire lorsque l'utilisateur les entre
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('http://localhost:1337/auth/local', formData);
